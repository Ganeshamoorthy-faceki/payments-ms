...
clientSchema.statics.findByFaceIdFromArray =  async (face_ids) =>{
...
clientSchema.statics.updateClientFaceId =  async (client_id,face_ids,image_id) =>{
...
clientSchema.statics.deleteClient =  async (client_id) =>{
...
clientSchema.statics.findClientByID =  async (client_id) =>{
...
clientSchema.statics.findClientByEmailID =  async (email) =>{
